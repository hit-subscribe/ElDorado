...
namespace ElDorado.Console.Tests.WritingCalendar
{
    ...
    public class When_Updating_Trello_From_PlanningSpreadsheet_BlogPostSynchronizer_Should
    {
        ...
        {
            PlanningSpreadsheetService.Arrange(pss => pss.GetPlannedPosts()).Returns(new List<BlogPost>() { UnapprovedPostFromSpreadsheet, AprpovedPostFromSpreadsheet, PostThatAlreadyExistsInTrello });
